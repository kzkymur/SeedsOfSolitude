...
const Button: React.FC<Props> = (props) => {
  ...
  return (
    <div className={props.className}>
      <p className={`${style.buttonName} ${style.rubrikNew} ${props.pageNumber == 3 ? style.buttonNameColorChange : ""}`}>{button_name}</p>
...
const ButtonCircleSvg: React.FC<CircleProps> = (props) => {
  return (
    ...
    >
      <path
        className={`${style.buttonCircle} ${props.pageNumber == 3 ? style.buttonColorChange : ""}`}
