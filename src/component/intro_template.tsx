...
const Introduction_1: React.FC<Props> = (props) => {
  return (
    <div className={`${style.wrapper} ${(props.pageNumber == props.intro_number + 2 || props.pageNumber == props.intro_number + 4) ? style.wrapperHide : ""}`}>
        <h1 className={`${style.title} ${style.rubrikNewLite}`}>{props.title}</h1>
